...
export type GetLessonsQuery = { __typename?: 'Query', lessons: Array<{ __typename?: 'Lesson', title: string, slug: string, availableAt?: any | null, lessonType: LessonType, id: string }> };
